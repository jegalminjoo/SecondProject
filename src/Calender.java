...
public class Calender extends JDialog {
	...
	public Calender(String selectedDate) {
...
//		LocalDate selectDate = LocalDate.of(Integer.parseInt(selectDate1[0]), Integer.parseInt(selectDate1[1]), Integer.parseInt(selectDate1[2]));
	...
	protected void makeCalender(LocalDate date) {
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (jcb != null) {
					PlaneSdAdd1.lblselDay.setText(selectDay);
					PlaneSdAdd1.lblselDay.setForeground(new Color(60, 137, 117));
					dispose();
